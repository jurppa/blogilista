...
const favouriteTestBlog = {title: listWithOneBlog[0].title, author: listWithOneBlog[0].author, likes: listWithOneBlog[0].likes}
const blogs = [
    {
...
describe('current favourite blog', () => {
    test('when list has no blogs', () => {
    ...
    test('when list has one blog', () => {
        ...
        expect(result).toEqual(favouriteTestBlog)
    })
    test('when list has multiple blogs', () => {
        const result = listHelper.favouriteBlog(blogs)
        
        
        expect(result.name).toEqual(blogs[2].name)
    })
